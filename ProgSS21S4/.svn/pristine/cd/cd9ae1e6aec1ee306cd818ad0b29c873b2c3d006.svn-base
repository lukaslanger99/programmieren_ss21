...
import de.ostfalia.prog.s21ss.s4.model.exceptions.UngueltigesFeldException;
import de.ostfalia.prog.s21ss.s4.model.felder.Effektplaettchen;
import de.ostfalia.prog.s21ss.s4.model.felder.Plaettchen;
import de.ostfalia.prog.s21ss.s4.model.wettgeschaeft.Wette;
import de.ostfalia.prog.s21ss.s4.model.wettgeschaeft.Wettentyp;
import de.ostfalia.prog.s21ss.s4.model.wettgeschaeft.Wettgeschaeft;
import de.ostfalia.prog.s21ss.s4.model.wettgeschaeft.Wettplaettchen;

public class CamelUp implements de.ostfalia.prog.s21ss.s4.base.ICamelUp {
	...
	public void bewegeKamel(Charakter charakter) {
		...
		// wenn etappe vorbei wettplaettchen wieder zurück auf die stapel und wetten
		// abarbeiten
	 ...
	 * @return printer
	 */
	public String printAktiveWetten() {
		String[] wetten = wettgeschaeft.getWetten();
		String printer = "";
